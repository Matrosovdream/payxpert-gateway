...
class PXSettings {
    ...
    public static function get_admin_fields() {
        ...
        $fields = array(
            ...
            'seamless_checkout' => array(
                'title' => __('Seamless checkout', 'payxpert'), 
                'type' => 'checkbox', 
                'label' => __('Enable Seamless checkout', 'payxpert'), 
                'default' => 'no', 
                'description' => __('Enables Seamless checkout (no redirection)', 'payxpert') 
            ),
            /*'iframe_mode' => array(
